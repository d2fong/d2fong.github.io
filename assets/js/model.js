...
var ActivityCollectionModel = function() {
    ...
    this.listeners = [];
    this.data_points = [];
    this.last_submitted_data = null;


    this.notify = function(eventType, eventData) {
        var d = new Date();
        _.each(this.listeners, function(listener) {
           listener(eventType, d, eventData); 
        });
    }
};
...
var GraphModel = function() {
    ...
    this.availableGraphs = [
        'ListOfDataPoints',
        'TimeSpentGraph' // average time spent on activities, average health level
    ];
    this.currentGraph = this.availableGraphs[0];
